...
(python client.py --gpu --dim 2 --model symmetric --batchnorm --activ elu --features 40 --batch_size 128 | tail -1) >> output.txt; sleep $SLP
(python client.py --gpu --dim 2 --model symmetric --batchnorm --activ elu --features 48 --batch_size 128 | tail -1) >> output.txt; sleep $SLP
(python client.py --gpu --dim 2 --model symmetric --batchnorm --activ elu --features 56 --batch_size 128 | tail -1) >> output.txt; sleep $SLP
